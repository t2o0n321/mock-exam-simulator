...
class UIManager:
    ...
    def setup_ui(self):
        ...
        style = ttk.Style()
        # Use the "clam" theme for better color control on Windows
        ...
        # Define styles for navigation buttons with all states
        if not self.is_macos:
            style.configure("Answered.TButton", background="#a3e635")
            style.map("Answered.TButton",
                      background=[
                          ("active", "#90cc30"),  # Slightly darker shade for active state
                          ("pressed", "#90cc30"),
                          ("!active", "#a3e635"),
                          ("disabled", "#d3d3d3")
                      ])
            ...
            style.map("Flagged.TButton",
                      background=[
                          ("active", "#e68500"),  # Slightly darker shade for active state
                          ("pressed", "#e68500"),
                          ("!active", "#ff9500"),
                          ("disabled", "#d3d3d3")
                      ])
